        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  <h2 class="font-semibold text-xl text-gray-800 leading-tight">Chỉnh Sửa Thông Tin Sinh Viên</h2>
                  <p>Tại đây có thể chỉnh sửa thông tin sinh viên, chúng ta sử dụng <code>trang này</code> để chỉnh sửa thông tin sinh một sinh viên :</p>
                  ...
                  <form action="{{route('sinhvien.update', $sinhvien-> id)}}" method="POST" class="was-validated" style="margin-top: 20px;" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="firtname" placeholder="Nhập họ/Enter firth name" name="FirthName" value="{{$sinhvien-> FirthName}}" required>
                      <div class="valid-feedback">Đầy đủ thông tin.</div>
                      <div class="invalid-feedback">Thiếu thông tin, vui lòng nhập đủ.</div>
                    </div>
                    <div class="form-group">
                      <label class="font-semibold text-l text-gray-800 leading-tight" for="lastname">Tên/Last Name:</label>
                      <input type="text" class="form-control" id="lastname" placeholder="Nhập tên/Enter last name" name="LastName" value="{{$sinhvien-> LastName}}" required>
                      <div class="valid-feedback">Đầy đủ thông tin.</div>
                      <div class="invalid-feedback">Thiếu thông tin, vui lòng nhập đủ.</div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="birth" name="Birth" value="{{$sinhvien-> Birth}}" required>
                      <div class="valid-feedback">Đầy đủ thông tin.</div>
                      <div class="invalid-feedback">Thiếu thông tin, vui lòng nhập đủ.</div>
                    </div>
                    ...
                    <div class="radio-gender">
                      ...
                      @else
                        ...
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="Gender" value="Nữ" checked>Nữ
                          </label>
                        </div>
                      @endif
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" id="address" name="Address" required>{{$sinhvien-> Address}}</textarea>
                    </div>

                    <div class="form-group">
                      <label class="font-semibold text-l text-gray-800 leading-tight" for="birthplace">Nơi Sinh/Birth Place:</label>
                      <textarea class="form-control" rows="3" id="birthplace" name="BirthPlace" required>{{$sinhvien-> BirthPlace}}</textarea>
                    </div>
                    
                    <div class="form-group">
                      <label class="font-semibold text-l text-gray-800 leading-tight" for="email">Email:</label>
                      <input type="text" class="form-control" id="email" placeholder="Nhập email/Enter email" name="Email" value="{{$sinhvien-> Email}}" required>
                      <div class="valid-feedback">Đầy đủ thông tin.</div>
                      <div class="invalid-feedback">Thiếu thông tin, vui lòng nhập đủ.</div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="phonenumber" placeholder="Nhập số điện thoại/Enter phone number" name="PhoneNumber" value="{{$sinhvien-> PhoneNumber}}" required>
                      <div class="valid-feedback">Đầy đủ thông tin.</div>
                      <div class="invalid-feedback">Thiếu thông tin, vui lòng nhập đủ.</div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="citizenidentitycard" placeholder="Nhập số căn cước công dân/Enter citizen identity card" name="CitizenIdentityCard" value="{{$sinhvien-> CitizenIdentityCard}}" required>
                      <div class="valid-feedback">Đầy đủ thông tin.</div>
                      <div class="invalid-feedback">Thiếu thông tin, vui lòng nhập đủ.</div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control-file border" name="Image" id="cardimage" value="{{$sinhvien-> Image}}">
                    </div>
